...
function drawGUI(){
  ...
  guiImgButton('static/mask_larn/assets/mask01.svg', 20, 20, 70, addLabel1Data);
  guiImgButton('static/mask_larn/assets/mask02.svg', 100, 20, 70, addLabel2Data);
  guiImgButton('static/mask_larn/assets/brain.svg', 180, 20, 70, trainModel);
  guiImgButton('static/mask_larn/assets/download.svg', 260, 20, 70, downloadModel);
  guiImgButton('static/mask_larn/assets/upload.svg', 340, 20, 70, uploadModel);
}
...
function uploadModel() {
  const modelInfo = {
    model: 'static/mask_larn/model/model.json',
    metadata: 'static/mask_larn/model/model_meta.json',
    weights: 'static/mask_larn/model/model.weights.bin',
  };
